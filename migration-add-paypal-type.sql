-- Adicionar PayPal como tipo válido na constraint de payment_methods
...
-- 1. Criar tabela temporária com constraint atualizada
CREATE TABLE payment_methods_new (
  id TEXT PRIMARY KEY,
  user_id INTEGER NOT NULL,
  name TEXT NOT NULL,
  type TEXT NOT NULL CHECK(type IN ('pix', 'international', 'paypal')),
